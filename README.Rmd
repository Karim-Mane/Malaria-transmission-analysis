...
X = matrix(0, 3, 5)
rownames(X) = c("raw", "minor_David", "minor_Karim")
...
p1 = ggplot(joined, aes(x=joined$`rMaf>0`, y=joined$`i.rMaf>0`)) + 
    geom_point(shape=19, size=0.1) +
    geom_smooth(method=lm,  linetype="dashed",color="darkred", fill="blue") +
    ggtitle(paste0("raw vs minor_Karim; MAF>0%; correlation coefficient=",round(cor(joined$`rMaf>0`, joined$`i.rMaf>0`), digits = 2))) +
    xlab("raw") +ylab("minor_Karim") +
    theme(
        plot.background = element_blank(),
        panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
...
p2 = ggplot(joined, aes(x=joined$`rMaf>10`, y=joined$`i.rMaf>10`)) + 
    geom_point(shape=19, size=0.1) +
    geom_smooth(method=lm,  linetype="dashed",color="darkred", fill="blue") +
    ggtitle(paste0("raw vs minor_Karim; MAF>10%; correlation coefficient=",round(cor(joined$`rMaf>10`, joined$`i.rMaf>10`), digits = 2))) +
    xlab("raw") +ylab("minor_Karim") +
    theme(
        plot.background = element_blank(),
        panel.grid.major = element_blank(),
...
p3 = ggplot(joined, aes(x=joined$`rMaf>20`, y=joined$`i.rMaf>20`)) + 
    geom_point(shape=19, size=0.1) +
    geom_smooth(method=lm,  linetype="dashed",color="darkred", fill="blue") +
    ggtitle(paste0("raw vs minor_Karim; MAF>20%; correlation coefficient=",round(cor(joined$`rMaf>20`, joined$`i.rMaf>20`), digits = 2))) +
    xlab("raw") +ylab("minor_Karim") +
    theme(
        plot.background = element_blank(),
        panel.grid.major = element_blank(),
...
p4 = ggplot(joined, aes(x=joined$`rMaf>30`, y=joined$`i.rMaf>30`)) + 
    geom_point(shape=19, size=0.1) +
    geom_smooth(method=lm,  linetype="dashed",color="darkred", fill="blue") +
    ggtitle(paste0("raw vs minor_Karim; MAF>30%; correlation coefficient=",round(cor(joined$`rMaf>30`, joined$`i.rMaf>30`), digits = 2))) +
    theme(plot.title = element_text(size = 5, face = "bold")) +
    xlab("raw") +ylab("minor_Karim") +
    theme(
        plot.background = element_blank(),
...
p5 = ggplot(joined, aes(x=joined$`rMaf>40`, y=joined$`i.rMaf>40`)) + 
    geom_point(shape=19, size=0.1) +
    geom_smooth(method=lm,  linetype="dashed",color="darkred", fill="blue") +
    ggtitle(paste0("raw vs minor_Karim; MAF>40%; correlation coefficient=",round(cor(joined$`rMaf>40`, joined$`i.rMaf>40`), digits = 2))) +
    xlab("raw") +ylab("minor_David") +
    theme(
        plot.background = element_blank(),
        panel.grid.major = element_blank(),
