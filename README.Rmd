...
#'Combined_0.6.RDS' is the file with all relatedness inclusing within population
#---
#relatednessDir="/Users/km28/Documents/Karim/Karim/Gitlab/Transmission/RelatednessFolder"
...
# creating the site connector lines
tmp_gps = gps
names(tmp_gps) = c('Lat','Long','name')
source(paste0(relatednessDir,"/Get_Lines_Connectors.R"))
system(sprinft("mkdir -p %s", paste0(relatednessDir,"/SiteConnectors")))
curvedLines(tmp_gps, paste0(relatednessDir,"/SiteConnectors"))  #note that this requires python3 to be installed on your machine
...
#comparing mean IBD between same and different village
